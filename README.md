...
- Geographical distribution on excess deaths on heat event days based on initial preliminary analysis: [Map](https://app.datawrapper.de/map/LTVsM/publish)
![Map](./mockup/initial_map.png)
